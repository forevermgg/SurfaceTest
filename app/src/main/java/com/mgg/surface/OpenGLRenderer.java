...
final class OpenGLRenderer {
    ...
    private final ImageProcessingUtilTest imageProcessingUtilTest = new ImageProcessingUtilTest();
    ...
    private void renderLatest() {
        ...
        timestampNs = mPreviewTexture.getTimestamp();
        ...
        if (mSurfaceSize != null) {
            ...
            if (success && mFrameUpdateListener != null) {
                ...
                try {
                    ...
                    executor.execute(() -> listener.accept(finalTimestampNs));
                } catch (RejectedExecutionException e) {
    ...
    void execFunction(@NonNull Runnable command) {
