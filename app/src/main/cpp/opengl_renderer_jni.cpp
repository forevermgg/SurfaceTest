...
Java_com_mgg_surface_OpenGLRenderer_initContext(
...
Java_com_mgg_surface_OpenGLRenderer_setWindowSurface(
...
Java_com_mgg_surface_OpenGLRenderer_getTexName(
...
JNIEXPORT jboolean JNICALL
Java_com_mgg_surface_OpenGLRenderer_renderTexture(
...
Java_com_mgg_surface_OpenGLRenderer_closeContext(
        JNIEnv *env, jclass clazz, jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
