...
extern "C" {
JNIEXPORT jint Java_com_mgg_surface_ImageProcessingUtil_nativeCopyBetweenByteBufferAndBitmap (
        JNIEnv* env,
        jclass,
        jobject bitmap,
...
JNIEXPORT jint Java_com_mgg_surface_ImageProcessingUtil_nativeShiftPixel(
        JNIEnv* env,
        jclass,
        jobject src_y,
        jint src_stride_y,
 ...
 */
JNIEXPORT jint Java_com_mgg_surface_ImageProcessingUtil_nativeWriteJpegToSurface(
        JNIEnv *env,
        jclass,
...
JNIEXPORT jint Java_com_mgg_surface_ImageProcessingUtil_nativeConvertAndroid420ToABGR(
        JNIEnv* env,
        jclass,
        jobject src_y,
        jint src_stride_y,
    ...
    uint8_t* buffer_ptr = reinterpret_cast<uint8_t*>(buffer.bits);
    uint8_t* converted_buffer_ptr = (has_rotation && converted_buffer != NULL)
...
JNIEXPORT jint
Java_com_mgg_surface__ImageProcessingUtil_nativeConvertAndroid420ToBitmap(
        JNIEnv* env,
        jclass,
        jobject src_y,
        jint src_stride_y,
...
JNIEXPORT jint Java_com_mgg_surface_ImageProcessingUtil_nativeRotateYUV(
        JNIEnv* env,
        jclass,
        jobject src_y,
        jint src_stride_y,
